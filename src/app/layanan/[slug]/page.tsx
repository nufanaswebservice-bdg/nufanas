        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-12 p-8 rounded-2xl gradient-primary text-white text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="https://wa.me/6282216667733" target="_blank" rel="noopener noreferrer" className="h-11 px-6 rounded-lg border border-white/30 text-white font-medium inline-flex items-center hover:bg-white/10 transition-all">
                WhatsApp Sekarang
              </a>
            </div>
          </section>
